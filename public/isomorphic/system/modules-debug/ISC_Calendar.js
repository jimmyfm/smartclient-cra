/*
  ...
  Version v12.1p_2020-07-10/LGPL Deployment (2020-07-10)
...
if (window.isc && isc.version != "v12.1p_2020-07-10/LGPL Deployment" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v12.1p_2020-07-10/LGPL Deployment'. Mixing resources from different "
...
// cell hovers
    ...
    */
    ...
    getNewEventDefaults : function (event) {
        ...
        var evt = event || {};
        var cal = this.calendar;
        if (!evt[cal.startDateField]) {
            // start from the mouse-date, or the current datetime (addEvent button-click)
            var sDate = this.getDateFromPoint() || isc.DateUtil.createDatetime();
