...
isc.RichTextCanvas.addMethods({
    ...
    _setupEditArea : function () {
        ...
        // set the background-color of the document-body and the HTML element (the documentElement)
        // to transparent, so that RichTextEditor.editAreaBackgroundColor correctly shows through
